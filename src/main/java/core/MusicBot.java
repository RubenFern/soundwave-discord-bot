    ...
    private void registerSlashCommands(Guild guild) {
        guild.updateCommands().addCommands(
                net.dv8tion.jda.api.interactions.commands.build.Commands
                        .slash(Commands.PLAY.getName(), "Reproduce audio desde YouTube")
                        .addOption(OptionType.STRING, "query", "URL o término de búsqueda", true),
                net.dv8tion.jda.api.interactions.commands.build.Commands
                        .slash(Commands.SKIP.getName(), "Salta a la siguiente canción en la cola"),
                net.dv8tion.jda.api.interactions.commands.build.Commands
                        .slash(Commands.STOP.getName(), "Detiene la reproducción y limpia la cola"),
                net.dv8tion.jda.api.interactions.commands.build.Commands
                        .slash(Commands.PAUSE.getName(), "Pausa la canción actual temporalmente"),
                net.dv8tion.jda.api.interactions.commands.build.Commands
                        .slash(Commands.CONTINUE.getName(), "Reanuda la música si estaba pausada"),
                net.dv8tion.jda.api.interactions.commands.build.Commands
                        .slash(Commands.QUEUE.getName(), "Muestra la lista de canciones pendientes"),
                net.dv8tion.jda.api.interactions.commands.build.Commands
                        .slash(Commands.NOW_PLAYING.getName(), "Muestra la canción que está sonando y su progreso"),
                net.dv8tion.jda.api.interactions.commands.build.Commands
                        .slash(Commands.HELP.getName(), "Muestra la lista de comandos y ayuda")
        ).queue();
    }
